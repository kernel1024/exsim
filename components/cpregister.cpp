    ...
    QCPBase(parent,aOwner)
{
    ...
    f1Out = new QCPOutput(this,this,"1");
    fOutputs.append(f1Out);
    f2Out = new QCPOutput(this,this,"2");
    fOutputs.append(f2Out);
    f4Out = new QCPOutput(this,this,"4");
    fOutputs.append(f4Out);
    f8Out = new QCPOutput(this,this,"8");
    fOutputs.append(f8Out);

    f1Inp = new QCPInput(this,this,"1");
    fInputs.append(f1Inp);
    f2Inp = new QCPInput(this,this,"2");
    fInputs.append(f2Inp);
    f4Inp = new QCPInput(this,this,"4");
    fInputs.append(f4Inp);
    f8Inp = new QCPInput(this,this,"8");
    fInputs.append(f8Inp);
    fCInp = new QCPInput(this,this,"C");
    fInputs.append(fCInp);
    fRInp = new QCPInput(this,this,"R");
    fInputs.append(fRInp);
    fLSInp = new QCPInput(this,this,"<-");
    fInputs.append(fLSInp);
    fRSInp = new QCPInput(this,this,"->");
    fInputs.append(fRSInp);
}
...
{
    int vsz = (QApplication::fontMetrics().height()+4)*10;
    if (vsz<80) vsz = 80;
    return QSize(100*zoom()/100,vsz*zoom()/100);
}
...
void QCPRegister::paintEvent(QPaintEvent *)
{
    ...
    rc = rect();
    rc.adjust(0,0,-p.fontMetrics().width("->")-getPinSize()/2-1,-1);
